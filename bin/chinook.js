...
(function() {
  var addAddress, argv, async, attachContainer, command, detachContainer, docker, ensureHostname, getFirstPort, hostnameKey, hostname_key_prefix, makeAddress, printAddresses, printAllAddresses, redis, removeAddress, replaceContainer, util, _, _hostname, _id, _new_id, _old_id, _printAddresses;
