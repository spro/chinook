...
(function() {
  var Chinook, addAddress, address_containers, argv, async, command, connectToRedis, docker, ensureHostname, exports, getAllContainers, getFirstPort, hostnameKey, hostname_key_prefix, makeAddress, printAddresses, printAllAddresses, printAllContainers, redis, redis_address, redis_host, redis_port, removeAddress, util, _, _hostname, _id, _new_id, _old_id, _printAddresses;
